 ...
 * the {@link theme_postit_less_variables()} here because we need to create selectors or
 * alter existing ones.
 *
 * @param theme_config $theme The theme config object.
 * @return string Raw LESS code.
 */
function theme_postit_extra_less($theme) {
    $content = '';
 ...
 */
function theme_postit_process_css($css, $theme) {

    // Set the background image for the logo.
    $logo = $theme->setting_file_url('logo', 'logo');
    $css = theme_postit_set_logo($css, $logo);
    ...
    $css = theme_postit_set_customcss($css, $customcss);
 ...
 */
function theme_postit_set_logo($css, $logo) {
    $tag = '[[setting:logo]]';
    $replacement = $logo;
 ...
 * @return bool
 */
function theme_postit_pluginfile($course, $cm, $context, $filearea, $args, $forcedownload, array $options = array()) {
    if ($context->contextlevel == CONTEXT_SYSTEM && ($filearea === 'logo' || $filearea === 'backgroundimage')) {
        $theme = theme_config::load('postit');
 ...
 */
function theme_postit_set_customcss($css, $customcss) {
